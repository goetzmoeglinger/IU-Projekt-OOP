...
def start_gui():
    ...
    # Legende
    label_legende_inaktiv = tk.Label(dashboard,  fg="grey", relief="solid", bd=0,
                             text="inaktiv", font=("Helvetica", 10))
    label_legende_inaktiv.place(x=150, y=10, width=150, height=25) # bg="white"

    label_legende_aktiv = tk.Label(dashboard,  fg="green", relief="solid", bd=0,
                             text="aktiv", font=("Helvetica", 10))
    label_legende_aktiv.place(x=350, y=10, width=150, height=25) # bg="white"
    
    label_legende_eingereicht = tk.Label(dashboard,  fg="red", relief="solid", bd=0,
                             text="eingereicht", font=("Helvetica", 10))
    label_legende_eingereicht.place(x=550, y=10, width=150, height=25) # bg="white" 
   
    label_legende_abgeschlossen = tk.Label(dashboard,  fg="black", relief="solid", bd=0,
                             text="abgeschlossen", font=("Helvetica", 10))
    label_legende_abgeschlossen.place(x=750, y=10, width=150, height=25) # bg="white"
